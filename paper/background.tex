...
The left side of Figure~\ref{fig:choice} show edge probabilities
that reflect the outcome of the Bernoulli draw on line 2.
...
transition model yields a Markov decision process.
