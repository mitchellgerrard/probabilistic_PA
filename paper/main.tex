...
\item Develop one example that we can use to illustrate the different
techniques.  It should include a program fragment, a property, and
some kind of probability distribution.  (All: is there a favorite symbolic execution example from a paper)
\item Flesh out probability definitions in background (Someone?)
\item Develop the computing probabilities section (Anto)
\item Develop the probabilistic model checking section and backfill the background (Matt)
