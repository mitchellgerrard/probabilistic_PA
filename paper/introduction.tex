...
in symbolic execution~\cite{SymEx}, to define abstract domains
in data flow analysis~\cite{DataFlowAnalysis}, and to 
capture sets of data values that constitute reachable states via
predicate abstraction~\cite{PredicateAbstraction}.
