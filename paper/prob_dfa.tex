...
There has been recent work which explores computing ``expectation
invariants."
...
some property.
This is similar to the work of Di Pierro, but uses different 
theoretical machinery, such as fixed points and martingales.
...
observations.
In this setting, if a program trace does not match an observation
at a given point, that trace is not considered, and a new ``sample"
of the program is run. 
The program now implicitly specifies a probability distribution
