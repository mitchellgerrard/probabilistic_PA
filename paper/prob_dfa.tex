...
Di Pierro et al. \cite{DiPierro} aim to estimate the probability of a property,
...
property called {\sl expectation invariants} \cite{Chakarov}.
...
inference on this new class of probabilistic programs~\cite{Nori}.
