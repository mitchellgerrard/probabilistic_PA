...
\mycomment{Matt: do we want to cover probabilistic explicit state model checking?  It is in some sense easier to explain especially in relation to data flow analysis and symbolic execution.  PRISM actually has this as does MRMC and some other work.}
...
\subsubsection{More and varied probabilistic model checking}
     \begin{enumerate}
